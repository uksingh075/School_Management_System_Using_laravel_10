            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6" style="text-align: right">
                        <a href="{{ URL::to('/') }}/admin/student/add" class="btn btn-primary">Add New Student</a>
                    </div>
                </div>
            </div>
        </section>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-2">
                                            ...
                                            <input type="text" class="form-control" name="roll_number"
                                                placeholder="Enter roll number" value="{{ Request::get('roll_number') }}">
                                        </div>
                                        <div class="form-group col-md-2">
                                            <label>Class</label>
                                        ...
                                        <div class="form-group col-md-2">
                                            ...
                                            <input type="text" class="form-control" name="blood_group"
                                                placeholder="Enter blood group" value="{{ Request::get('blood_group') }}">
                                        </div>
                                        <div class="form-group col-md-2">
                                            <label>Status</label>
