                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('grade_name') is-invalid @enderror"
                                            name="grade_name" placeholder="Enter grade name" value="{{ old('grade_name', $getRecord->name) }}">
                                        @error('grade_name')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control @error('percent_from') is-invalid @enderror"
                                            name="percent_from" placeholder="Enter percent from" value="{{ old('percent_from', $getRecord->percent_from) }}">
                                        @error('percent_from')
                                            <p class="invalid-feedback">{{ $message }}</p>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control @error('percent_to') is-invalid @enderror"
                                            name="percent_to" placeholder="Enter percent to" value="{{ old('percent_to', $getRecord->percent_to) }}">
                                        @error('percent_to')
                                            <p class="invalid-feedback">{{ $message }}</p>
                                        @enderror
                                    </div>
